...
export const SITE_CONFIG = {
  ...
  tools: [
    ...
    },
    {
      id: 'reach-booster',
      number: 6,
      name: 'أداة زيادة نسبة الوصول (Reach Booster)',
      category: 'social',
      badge: 'تصدر النتائج',
    ...
    },
    {
      ...
      number: 7,
      name: 'بديل كانفا للتصميم (Canva Pro Alt)',
      category: 'design',
      badge: 'تصميم احترافي',
      shortDesc: 'إنشاء أفضل التصميمات والإعلانات وتعديل الصور باحترافية وسرعة.',
      features: [
  ...
  testimonials: [
    ...
    },
    {
      ...
      content: 'الكورس شرحه ممتاز ومباشر من غير رغي، وبديل كانفا وأداة مونتاج الفيديو ساعدوني جداً في إنجاز إعلانات عملائي بسرعة وبدون اشتراكات شهرية. أفضل استثمار عملته في شغلي.',
      rating: 5,
      verified: true,
      packageTaken: 'الباقة الشاملة VIP'
    },
